    ...
    <section className="pb-15 relative">
      <div className="relative w-full lg:max-w-3xl mx-auto">
        ...
        <motion.img
          ...
          initial={{ translateY: "25px", opacity: 0 }}
          whileInView={{ translateY: "0", opacity: 1 }}
          className="shadow-4xl hidden rounded-lg lg:block lg:absolute lg:top-24 lg:-right-30"
        ...
        <motion.img
          ...
          initial={{ translateY: "25px", opacity: 0 }}
          whileInView={{ translateY: "0", opacity: 1 }}
          className="shadow-4xl hidden rounded-lg lg:block lg:absolute lg:top-70 lg:-left-30"
