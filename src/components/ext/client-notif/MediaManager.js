     ...
     <section className="py-22">
          ...
          <div className="relative mx-auto mt-20 w-full lg:max-w-3xl">
            <motion.img
              ...
              src="/client-notif/client_notifications-media_manager.png"
            ...
            <motion.img
              ...
              src="/client-notif/illustration-menu-manager-right.png"
              alt="افزونه اعلان مشتری لاگوم"
            />
            <motion.img
              viewport={{ once: true }}
              ...
              whileInView={{ translateY: '0', opacity: 1 }}
              transition={{ delay: '0.3' }}
              className="shadow-3xl hidden rounded-lg ring-2 shadow-blue-800/5 ring-blue-500/7 lg:absolute lg:top-50 lg:-left-30 bg-white lg:block"
              src="/client-notif/client_notifications-upload_graphic.png"
              alt="افزونه اعلان مشتری لاگوم"
            />
          </div>
        </section>
