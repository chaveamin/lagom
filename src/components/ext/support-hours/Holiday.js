    ...
    <section className="py-22">
      ...
      <div className="relative mx-auto mt-20 w-full lg:max-w-3xl">
        <motion.img
          ...
          src="/support-hours/support_hours-holidays-main.png"
        ...
        <motion.img
          ...
          className="shadow-3xl hidden rounded-lg bg-white ring-2 shadow-blue-800/5 ring-blue-500/7 lg:absolute lg:top-90 lg:-right-30 lg:block"
          src="/support-hours/support_hours-holidays-icon.png"
          alt="افزونه ساعات کاری لاگوم"
        />
      </div>
    </section>
