export default function Pricing() {
  return (
    <section id="pricing" className="py-22 px-8 rounded-b-2xl">
      <div className="w-full lg:max-w-5xl mx-auto">
        <h2 className="lg:text-5xl text-3xl leading-14 font-black text-zinc-800 mb-16">
          قیمت گذاری
        </h2>
      </div>
      <div className="bg-blue-100 rounded-lg ring ring-blue-500 p-6 shadow-sm shadow-zinc-400 max-w-5xl mx-auto mb-10">
        <p className="font-light text-lg">
          این افزونه فقط با نسخه{" "}
          <a
            target="_blank"
          ...
          موجود در سایت سازگار است و اگر آن را قانونی یا جای دیگری خریداری کرده
          باشید، افزونه فعال نمیشود.
        </p>
      </div>
      <div className="flex items-center justify-center mx-auto flex-col bg-white ring ring-zinc-200 shadow-sm rounded-lg p-6 max-w-md">
        <div
          ...
          <h3 className="font-bold text-[40px]">
            1,880,000 <span className="font-light text-2xl">تومانءءء</span>
          </h3>
